...
<form method="post" action="php/donaters.php">

     <div class="container-fluid">

          <div class="row clearfix">
               <div>
                    <label>Enter Below the required
                         Fields</label>
                    <div class="col-md-12 col-sm-12">
                         <div class="col-md-12 col-sm-12">
                              ...
                              <br />
                              Birthdate<input autocomplete="off"
                                   type='date' name="bod"
                                   class="form-control" required
                         ...
                         <br />
                              ...
                              <input autocomplete="off"
                                   ...
                                   placeholder="Country">
                              <br />
                              Leave comment if you have any
                              disease and talk about your case
                              <textarea type="textarea" cols="8"
                                   rows="5" name="comment"
                                   class="form-control" required>
