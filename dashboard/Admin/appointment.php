...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="row">
              ...
              <div class="col-md-10 col-sm-12">
                <div class="form-outline mb-4">
                  <form class="example" action="/action_page.php" style="overflow: auto;">
                    <div id="div">
    ...
    while ($row = mysqli_fetch_array($result)) {
      echo '  
						  ...
						  <th><a href="delete-process-app.php?id=' . $row['id'] . '" ?><input type="button" value="delete" id="btn1" name="delete"></a></th>
